...
| [0004](0004-percentage-overlay-coordinates.md) | Overlay coords are resolution-agnostic percentages | Accepted (refined by 0005, 0018) |
...
| [0007](0007-default-720p-portrait.md) | Default config 720×1280 portrait, YouTube presets | Accepted (bitrates superseded by 0019) |
